...
#  set_unless[:tomcat6][:with_snmp]      = !languages[:java][:runtime][:name].match(/1.7.0_15/)
else
  set_unless[:tomcat6][:with_snmp]      = false
end

set_unless[:tomcat6][:java_home]        = "/usr/lib/jvm/java-1.7.0-openjdk-amd64"
...
set_unless[:tomcat6][:admin_user]     = "admin"
set_unless[:tomcat6][:admin_password] = "admin"
set_unless[:tomcat6][:permgen_min_free_in_mb] = 24
default[:tomcat6][:dir]  = "/etc/tomcat6/"
set[:tomcat6][:file] = "#{node[:tomcat6][:dir]}/context.xml"